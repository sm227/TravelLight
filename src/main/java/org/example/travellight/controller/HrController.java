...
public class HrController {
    ...
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "지원서 제출 성공", 
            content = @Content(schema = @Schema(implementation = ApiResponse.class))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "잘못된 요청", 
            content = @Content(schema = @Schema(implementation = ApiResponse.class)))
    })
    @PostMapping("/applications")
    public ResponseEntity<ApiResponse<HrDto.JobApplicationResponse>> submitJobApplication(
        ...
        return ResponseEntity.ok(ApiResponse.success("지원서가 성공적으로 제출되었습니다.", response));
    }

    @Operation(summary = "인재풀 등록", description = "인재풀에 등록합니다.")
    @ApiResponses(value = {
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "인재풀 등록 성공", 
            content = @Content(schema = @Schema(implementation = ApiResponse.class))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "잘못된 요청", 
            content = @Content(schema = @Schema(implementation = ApiResponse.class)))
    })
    @PostMapping("/talent-pool")
    public ResponseEntity<ApiResponse<HrDto.TalentPoolResponse>> submitTalentPoolApplication(
        ...
        return ResponseEntity.ok(ApiResponse.success("인재풀에 성공적으로 등록되었습니다.", response));
    }
    ...
    public ResponseEntity<ApiResponse<Page<HrDto.JobApplicationResponse>>> getAllJobApplications(
            @PageableDefault(size = 10) Pageable pageable) {
        log.info("모든 채용 지원서 조회 요청");
        Page<HrDto.JobApplicationResponse> applications = hrService.getAllJobApplications(pageable);
        return ResponseEntity.ok(ApiResponse.success("채용 지원서 목록을 조회했습니다.", applications));
    }
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<Page<HrDto.TalentPoolResponse>>> getAllTalentPool(
            @PageableDefault(size = 10) Pageable pageable) {
        log.info("모든 인재풀 조회 요청");
        Page<HrDto.TalentPoolResponse> talentPool = hrService.getAllTalentPool(pageable);
        return ResponseEntity.ok(ApiResponse.success("인재풀 목록을 조회했습니다.", talentPool));
    }
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<HrDto.JobApplicationResponse>> updateApplicationStatus(
        ...
        return ResponseEntity.ok(ApiResponse.success("지원서 상태가 변경되었습니다.", response));
    }
    ...
    @ApiResponses(value = {
        ...
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "권한 없음", 
            content = @Content(schema = @Schema(implementation = ApiResponse.class))),
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "인재풀 정보를 찾을 수 없음", 
            content = @Content(schema = @Schema(implementation = ApiResponse.class)))
    })
    @PutMapping("/admin/talent-pool/{talentId}/status")
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<HrDto.TalentPoolResponse>> updateTalentStatus(
        ...
        return ResponseEntity.ok(ApiResponse.success("인재풀 상태가 변경되었습니다.", response));
    }
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<Void>> deleteJobApplication(
            @Parameter(description = "지원서 ID", required = true)
            @PathVariable Long applicationId) {
        log.info("지원서 삭제 요청 - ID: {}", applicationId);
        hrService.deleteJobApplication(applicationId);
        return ResponseEntity.ok(ApiResponse.success("지원서가 삭제되었습니다.", null));
    }
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<Void>> deleteTalentPoolEntry(
            @Parameter(description = "인재풀 ID", required = true)
            @PathVariable Long talentId) {
        log.info("인재풀 삭제 요청 - ID: {}", talentId);
        hrService.deleteTalentPoolEntry(talentId);
        return ResponseEntity.ok(ApiResponse.success("인재풀 정보가 삭제되었습니다.", null));
    }
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<ApiResponse<HrDto.HrStatsResponse>> getHrStats() {
        log.info("HR 통계 조회 요청");
        HrDto.HrStatsResponse stats = hrService.getHrStats();
        return ResponseEntity.ok(ApiResponse.success("HR 통계를 조회했습니다.", stats));
    }
}