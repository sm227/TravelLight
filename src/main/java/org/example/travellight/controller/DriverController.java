...
public class DriverController {
    ...
    @PostMapping("/login")
    public ResponseEntity<CommonApiResponse<DriverDto.DriverResponse>> login(
        ...
        return ResponseEntity.ok(CommonApiResponse.success("로그인 성공", response));
    }

    @Operation(summary = "배달원 프로필 조회", description = "배달원 프로필 정보를 조회합니다.")
    @GetMapping("/{id}/profile")
    public ResponseEntity<CommonApiResponse<DriverDto.DriverResponse>> getDriverProfile(
    ...
    public ResponseEntity<CommonApiResponse<String>> updateDriverStatus(
            @Parameter(description = "배달원 ID", required = true)
            @PathVariable Long id,
        ...
        return ResponseEntity.ok(CommonApiResponse.success("상태가 변경되었습니다."));
    }

    @Operation(summary = "배달원 위치 업데이트", description = "배달원의 실시간 위치를 업데이트합니다.")
    @PutMapping("/{id}/location")
    public ResponseEntity<CommonApiResponse<String>> updateDriverLocation(
            @Parameter(description = "배달원 ID", required = true)
            @PathVariable Long id,
        ...
        return ResponseEntity.ok(CommonApiResponse.success("위치가 업데이트되었습니다."));
    }

    @Operation(summary = "배달원 통계 조회", description = "배달원의 통계 정보를 조회합니다.")
    @GetMapping("/{id}/stats")
    public ResponseEntity<CommonApiResponse<DriverDto.DriverStatsResponse>> getDriverStats(
            @Parameter(description = "배달원 ID", required = true)
            @PathVariable Long id) {
    ...
    @GetMapping("/online")
    public ResponseEntity<CommonApiResponse<List<DriverDto.DriverListResponse>>> getOnlineDrivers() {
    ...
    @GetMapping
    public ResponseEntity<CommonApiResponse<List<DriverDto.DriverListResponse>>> getAllDrivers() {
